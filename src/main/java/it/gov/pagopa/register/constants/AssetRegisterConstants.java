...
public class AssetRegisterConstants {
  ...
  public static final String ERROR_ENERGY_CLASS = "La classe energetica non è conforme con quella prevista nel DM del {}";
  ...
  public static final String STATUS_NOT_VALID = "Il prodotto è sottoposto alle verifiche previste dal DM del {} e pertanto non è possibile variare le informazioni ad esso collegate";
