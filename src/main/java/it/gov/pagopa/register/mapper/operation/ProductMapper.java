...
public class ProductMapper {
  ...
  public static ProductDTO toDTO(Product entity, String role){
    ...
    return ProductDTO.builder()
      ...
      .formalMotivation(entity.getFormalMotivation() == null || entity.getFormalMotivation().getFormalMotivation() == null  ? new FormalMotivationDTO("-", LocalDateTime.MIN) : entity.getFormalMotivation())
