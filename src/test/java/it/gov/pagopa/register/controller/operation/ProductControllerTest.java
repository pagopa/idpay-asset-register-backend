...
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.status;
  ...
  class ProductControllerTest {
    ...
    @Test
    void testGetProducts_SortByBatchNameAsc() throws Exception {
      ProductDTO productDTO = new ProductDTO();
      productDTO.setOrganizationId("organizationIdTest");
    ...
    @Test
    void testGetProducts_SortByBatchNameDesc() throws Exception {
      ProductDTO productDTO = new ProductDTO();
      productDTO.setOrganizationId("organizationIdTest");
      ...
      Mockito.when(productService.getProducts(eq("organizationIdTest"), any(), any(), any(), any(), any(), any()))
        .thenReturn(mockResponse);

      mockMvc.perform(get("/idpay/register/products")
          .header("x-organization-id", "organizationIdTest")
          .param("sort", "batchName,desc")
          .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    }

    @Test
    void testGetProducts_WithOtherSortParameter() throws Exception {
      ProductDTO productDTO = new ProductDTO();
      productDTO.setOrganizationId("organizationIdTest");
      ...
      mockMvc.perform(get("/idpay/register/products")
          .header("x-organization-id", "organizationIdTest")
          .param("sort", "registrationDate,asc")
          .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk());
    }
